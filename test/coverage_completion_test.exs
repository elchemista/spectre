  ...
  describe "strict state codec failure matrix" do
    ...
    test "validates state collection shapes, limits, and revisions" do
      invalid_states = [
        ...
        {%State{pending_effects: List.duplicate(%Effect{}, 257)},
         {:state_collection_too_large, :pending_effects, 257, 256}},
        {%State{planned_effects: List.duplicate(%Effect{}, 513)},
         {:state_collection_too_large, :planned_effects, 513, 512}},
        {%State{awaitables: List.duplicate(%Awaitable{}, 513)},
         {:state_collection_too_large, :awaitables, 513, 512}},
