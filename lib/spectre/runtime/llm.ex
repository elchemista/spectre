defmodule Spectre.LLM do
  ...
  @runtime_opt_keys [
    ...
    :stream_adapter,
    :stream_adapter_opts,
    :stream_default_max_output_tokens,
    :stream_demand,
    :stream_next_timeout,
    :stream_max_attempts,
    ...
    :stream_capacity,
    :inference_budget,
    :inference_cost_usage?,
    :inference_pricing_ref,
    :inference_max_attempts,
    :inference_heartbeat_interval,
    :inference_observer_lane,
    :inference_progress_commit_interval,
    :inference_progress_limit,
    :inference_stream_checkpoint_interval,
    :correlation_id,
    :causation_id,
    :provenance,
    :journal_sequence,
