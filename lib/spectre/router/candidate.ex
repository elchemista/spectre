defmodule Spectre.Router.Candidate do
  ...
  def to_route(%__MODULE__{} = candidate, labels \\ []) do
    Spectre.Route.new(%{
      ...
      scope: candidate.scope || :agent,
      rule: candidate.rule,
      injections: (candidate.rule && candidate.rule.injections) || [],
      definition_injections: (candidate.rule && candidate.rule.definition_injections) || [],
